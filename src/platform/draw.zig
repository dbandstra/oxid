...
const Transform = @import("../draw.zig").Transform;

pub fn draw_untextured_rect_mvp(ps: *Platform.State, mvp: *const Mat4x4, color: Vec4, outline: bool) void {
...
pub fn draw_textured_rect_mvp(ps: *Platform.State, mvp: *const Mat4x4, tex_id: c.GLuint, transform: Transform) void {
  ...
  if (ps.shaders.texture_attrib_tex_coord >= 0) { // ?
    switch (transform) {
      Transform.Identity => c.glBindBuffer(c.GL_ARRAY_BUFFER, ps.static_geometry.rect_2d_tex_coord_buffer_normal),
      Transform.FlipHorizontal => c.glBindBuffer(c.GL_ARRAY_BUFFER, ps.static_geometry.rect_2d_tex_coord_buffer_flip_horizontal),
      Transform.FlipVertical => c.glBindBuffer(c.GL_ARRAY_BUFFER, ps.static_geometry.rect_2d_tex_coord_buffer_flip_vertical),
      Transform.RotateClockwise => c.glBindBuffer(c.GL_ARRAY_BUFFER, ps.static_geometry.rect_2d_tex_coord_buffer_rotate_clockwise),
      Transform.RotateCounterClockwise => c.glBindBuffer(c.GL_ARRAY_BUFFER, ps.static_geometry.rect_2d_tex_coord_buffer_rotate_counter_clockwise),
    }
