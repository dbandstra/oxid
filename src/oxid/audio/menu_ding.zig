    ...
    pub fn init() MenuDingVoice {
        ...
        return .{
            ...
            .note_tracker = zang.Notes(Instrument.NoteParams).NoteTracker.init(&[_]SongEvent {
                ...
                .{ .params = .{ .freq = 60.0, .note_on =  true }, .note_id =  5, .t = f * 0.04 },
                .{ .params = .{ .freq = 40.0, .note_on =  true }, .note_id =  6, .t = f * 0.05 },
                .{ .params = .{ .freq = 50.0, .note_on =  true }, .note_id =  7, .t = f * 0.06 },
                .{ .params = .{ .freq = 30.0, .note_on =  true }, .note_id =  8, .t = f * 0.07 },
                .{ .params = .{ .freq = 40.0, .note_on =  true }, .note_id =  9, .t = f * 0.08 },
                .{ .params = .{ .freq = 20.0, .note_on =  true }, .note_id = 10, .t = f * 0.09 },
                .{ .params = .{ .freq = 30.0, .note_on = false }, .note_id = 11, .t = f * 0.1  },
            }),
